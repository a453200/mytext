...
def extract_characters(image):
    ...
    # Find individual character regions
...
def show_login_screen():
    ...
    st.write("Please log in to access your personal handwriting library.")
            ...
            if target_chars:
                ...
                if len(char_images) == len(target_chars):
                    ...
                    for i, char in enumerate(target_chars):
                        ...
                        # Save to this user's personal library
                        user_library[char] = char_images[i]
                    ...
                    st.error(
                        f"You entered {len(target_chars)} characters, "
                        f"but {len(char_images)} character regions were detected. "
                        f"Please check the image or your input."
                    )
